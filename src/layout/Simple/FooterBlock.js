...
import imgfooterlogo from 'assets/images/logo.png';
                ...
                <Grid container spacing={2} sx={{ [theme.breakpoints.down('md')]: { pr: 0, textAlign: 'center' } }}>
                  ...
                  <Grid item xs={12}>
                    <Typography variant="body1" sx={{ color: theme.palette.common.white }}>
                      What is next? Checkout the Upcoming release of Elevate360.
                    </Typography>
                  </Grid>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={4}>
              ...
              >
                <Grid container spacing={2}>
                  <Grid item xs={12}>
                    <CardMedia component="img" image={imgfooterlogo} sx={{ width: '50%' }} />
                  </Grid>
                  <Grid item xs={12}>
                    <Typography variant="subtitle1" style={{ textAlign: 'justify' }} sx={{ fontWeight: 400, color: theme.palette.common.white }}>
                      Streamlining performance management. Trusted by organizations globally. Simplify task assignments, monitor performance, and facilitate salary settlements seamlessly. Elevate your performance experience with precision and ease.
                    </Typography>
                  </Grid>
                </Grid>
              </motion.div>
